...
export default function FilterDrawer({ filterType, maxPrice }: FilterDrawerProps) {
  ...
  // Asegurarnos de que el portal solo se renderice en el cliente
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  // Contenido del Drawer que enviaremos al Portal
  const drawerContent = (
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <div className="fixed inset-y-0 left-0 max-w-full flex">
        <div className="w-screen max-w-md bg-[#FBF9F5] shadow-2xl flex flex-col h-screen">
          {/* Encabezado */}
          <div className="p-6 border-b border-[#E8E2D8] flex items-center justify-between bg-white shrink-0">
          ...
          {/* Pie del Panel */}
          <div className="p-4 bg-white border-t border-[#E8E2D8] text-center text-xs font-semibold text-slate-400 shrink-0">
  ...
  return (
    <>
      {/* BOTÓN ICONO (Se queda en el header) */}
      <button
      ...
      {/* PORTAL (Manda el modal al body para escapar del header) */}
