  ...
  return (
    <div className="flex items-center justify-between pt-6 border-t border-[#E8E2D8] mt-8 gap-4">
      ...
      <button
        ...
        className="px-6 py-3.5 bg-linear-to-r from-brand-primary to-emerald-700 hover:opacity-95 text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-md transition-all active:scale-95 disabled:opacity-55 disabled:cursor-not-allowed flex items-center gap-2 cursor-pointer"
      >
        {isProcessing ? (
          <>
